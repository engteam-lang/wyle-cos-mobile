...
class CommercialAppsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CommercialAppsScreen> createState() => _CommercialAppsScreenState();
}
    ...
    child: Row(
      children: [
        ...
        Container(
          width: 34, height: 34,
          decoration: BoxDecoration(
            color: const Color(0xFF2E1A08), borderRadius: BorderRadius.circular(9)),
          child: const Icon(Icons.shopping_bag_rounded, color: Color(0xFFFFA726), size: 18),
        ),
